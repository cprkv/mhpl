...
cLuxPlayerInsanityCollapse::cLuxPlayerInsanityCollapse(cLuxPlayer* apPlayer)
    : iLuxPlayerHelper(apPlayer, "LuxPlayerInsanityCollapse") {
...
cLuxPlayerSanity::cLuxPlayerSanity(cLuxPlayer* apPlayer)
    : iLuxPlayerHelper(apPlayer, "LuxPlayerSanity") {
...
cLuxPlayerInDarkness::cLuxPlayerInDarkness(cLuxPlayer* apPlayer)
    : iLuxPlayerHelper(apPlayer, "LuxPlayerInDarkness") {
