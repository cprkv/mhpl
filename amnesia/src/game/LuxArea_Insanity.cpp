...
cLuxAreaLoader_Insanity::cLuxAreaLoader_Insanity(const tString& asName)
...
cLuxArea_Insanity::cLuxArea_Insanity(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxArea(asName, alID, apMap, eLuxAreaType_Insanity) {
