...
class cLuxInsanityHandler_Event_SaveData : public iSerializable {
  kSerializableClassInit(cLuxInsanityHandler_Event_SaveData) public : bool mbUsed;
};

//----------------------------------------------

class cLuxInsanityHandler_Set_SaveData : public iSerializable {
  kSerializableClassInit(cLuxInsanityHandler_Set_SaveData) public : cLuxInsanityHandler_Set_SaveData() {}
  cLuxInsanityHandler_Set_SaveData(const tString& asName)
      : msName(asName) {}
...
class cLuxInsanityHandler_SaveData : public iSerializable {
  kSerializableClassInit(cLuxInsanityHandler_SaveData) public : void FromInsanityHandler(cLuxInsanityHandler* apData);
