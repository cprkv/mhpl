...
cModelEditorWindowUserSettings::cModelEditorWindowUserSettings(cModelEditor* apEditor)
    : iEditorWindowPopUp(apEditor, "User Settings Window", true, true, false, cVector2f(700, 500)) {
  mpEditor     = apEditor;
  mpInputPanel = NULL;
}
