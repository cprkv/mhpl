...
cModelEditorWindowAnimations::cModelEditorWindowAnimations(cModelEditor* apEditor)
    : iEditorWindowPopUp(apEditor, "Animation edition window", true, true, false, cVector2f(650, 450)) {
  mpEditor = apEditor;
}
