...
static eEditorParticleEmitterType ToDrawType(const char* apString) {
  ...
  if (sType == "point")
    ...
    return eEditorParticleEmitterType_Line;
  else if (sType == "axis")
    return eEditorParticleEmitterType_Axis;
...
cEntityWrapperTypeParticleEmitter::cEntityWrapperTypeParticleEmitter()
    : iEntityWrapperType(eEditorEntityType_ParticleEmitter, _W("ParticleEmitter"), "ParticleEmitter") {
...
cEntityWrapperDataParticleEmitter::cEntityWrapperDataParticleEmitter(iEntityWrapperType* apType)
    : iEntityWrapperData(apType) {
  /*
...
cEntityWrapperParticleEmitter::cEntityWrapperParticleEmitter(iEntityWrapperData* apData)
    : iEntityWrapper(apData) {
}
//----------------------------------------------------------------------
...
bool cEntityWrapperParticleEmitter::GetProperty(int alPropID, int& alX) {
  switch (alPropID) {
    case ePEInt_MaxParticleNum:
      alX = GetMaxParticleNum();
      break;
    case ePEInt_WarmUpStepsPerSec:
      alX = GetWarmUpStepsPerSec();
      break;
    case ePEInt_CollisionUpdateRate:
      alX = GetCollisionUpdateRate();
      break;
    case ePEInt_LowFreqPoints:
      alX = GetLowFreqPoints();
      break;
    case ePEInt_HighFreqPoints:
      alX = GetHighFreqPoints();
      break;
...
bool cEntityWrapperParticleEmitter::GetProperty(int alPropID, bool& abX) {
  switch (alPropID) {
    ...
    case ePEBool_ApplyNoiseToStart:
      abX = GetApplyNoiseToStart();
      break;
    case ePEBool_ApplyNoiseToEnd:
      abX = GetApplyNoiseToEnd();
      break;
...
bool cEntityWrapperParticleEmitter::GetProperty(int alPropID, tString& asX) {
  switch (alPropID) {
    case ePEStr_PEType:
      asX = PETypeToString(GetPEType());
      break;
    case ePEStr_StartPosType:
      asX = StartPosTypeToString(GetStartPosType());
      break;
    case ePEStr_StartVelType:
      asX = StartPosTypeToString(GetStartVelType());
      break;
    case ePEStr_CoordSystem:
      asX = CoordSystemToString(GetCoordSystem());
      break;
    case ePEStr_GravityType:
      asX = GravityTypeToString(GetGravityType());
      break;

    case ePEStr_PartSpinType:
      asX = PartSpinTypeToString(GetPartSpinType());
      break;

    case ePEStr_DrawType:
      asX = DrawTypeToString(GetDrawType());
      break;
    case ePEStr_DeathType:
      asX = DeathTypeToString(GetDeathType());
      break;

    case ePEStr_SubDivType:
      asX = SubDivTypeToString(GetSubDivisionType());
      break;
...
bool cEntityWrapperParticleEmitter::GetProperty(int alPropID, cVector2f& avX) {
  switch (alPropID) {
    case ePEVec2f_MinStartAngles:
      avX = GetMinStartAngles();
      break;
    case ePEVec2f_MaxStartAngles:
      avX = GetMaxStartAngles();
      break;
    case ePEVec2f_MinStartVelAngles:
      avX = GetMinStartVelAngles();
      break;
    case ePEVec2f_MaxStartVelAngles:
      avX = GetMaxStartVelAngles();
      break;
...
bool cEntityWrapperParticleEmitter::SetProperty(int alPropID, const int& alX) {
  switch (alPropID) {
    case ePEInt_MaxParticleNum:
      SetMaxParticleNum(alX);
      break;
    case ePEInt_WarmUpStepsPerSec:
      SetWarmUpStepsPerSec(alX);
      break;
    case ePEInt_CollisionUpdateRate:
      SetCollisionUpdateRate(alX);
      break;
    case ePEInt_LowFreqPoints:
      SetLowFreqPoints(alX);
      break;
    case ePEInt_HighFreqPoints:
      SetHighFreqPoints(alX);
      break;
    case ePEInt_NumFiles:
      SetNumFiles(alX);
      break;
...
bool cEntityWrapperParticleEmitter::SetProperty(int alPropID, const float& afX) {
  switch (alPropID) {
    case ePEFloat_ParticlesPerSecond:
      SetParticlesPerSecond(afX);
      break;
    case ePEFloat_StartTimeOffset:
      SetStartTimeOffset(afX);
      break;
    case ePEFloat_WarmUpTime:
      SetWarmUpTime(afX);
      break;
    case ePEFloat_MinPauseLength:
      SetMinPauseLength(afX);
      break;
    case ePEFloat_MaxPauseLength:
      SetMaxPauseLength(afX);
      break;
    case ePEFloat_MinPauseInterval:
      SetMinPauseInterval(afX);
      break;
    case ePEFloat_MaxPauseInterval:
      SetMaxPauseInterval(afX);
      break;

    case ePEFloat_MinStartRadius:
      SetMinStartRadius(afX);
      break;
    case ePEFloat_MaxStartRadius:
      SetMaxStartRadius(afX);
      break;

    case ePEFloat_MinStartVelSpeed:
      SetMinStartVelSpeed(afX);
      break;
    case ePEFloat_MaxStartVelSpeed:
      SetMaxStartVelSpeed(afX);
      break;

    case ePEFloat_MinSpeedMultiply:
      SetMinSpeedMultiply(afX);
      break;
    case ePEFloat_MaxSpeedMultiply:
      SetMaxSpeedMultiply(afX);
      break;

    case ePEFloat_MinVelMaximum:
      SetMinVelMaximum(afX);
      break;
    case ePEFloat_MaxVelMaximum:
      SetMaxVelMaximum(afX);
      break;
    ...
    case ePEFloat_MiddleRelSizeTime:
      SetMiddleRelSizeTime(afX);
      break;
    case ePEFloat_MiddleRelSizeLength:
      SetMiddleRelSizeLength(afX);
      break;
    case ePEFloat_MiddleRelColorTime:
      SetMiddleRelColorTime(afX);
      break;
    case ePEFloat_MiddleRelColorLength:
      SetMiddleRelColorLength(afX);
      break;
    case ePEFloat_MinCollisionMax:
      SetMinCollisionMax(afX);
      break;
    case ePEFloat_MaxCollisionMax:
      SetMaxCollisionMax(afX);
      break;

    case ePEFloat_MinBounceAmount:
      SetMinBounceAmount(afX);
      break;
    case ePEFloat_MaxBounceAmount:
      SetMaxBounceAmount(afX);
      break;
...
bool cEntityWrapperParticleEmitter::SetProperty(int alPropID, const bool& abX) {
  switch (alPropID) {
    case ePEBool_Respawn:
      ...
      break;
    case ePEBool_UseDirection:
      SetUsesDirection(abX);
      break;
    case ePEBool_UsePartSpin:
      SetUsePartSpin(abX);
      break;
    case ePEBool_UseRevolution:
      SetUseRevolution(abX);
      break;
    case ePEBool_MultiplyRGBWithAlpha:
      SetMultiplyRGBWithAlpha(abX);
      break;
    case ePEBool_Collides:
      SetCollides(abX);
      break;
    case ePEBool_UseBeamNoise:
      ...
      break;
    case ePEBool_ApplyNoiseToStart:
      SetApplyNoiseToStart(abX);
      break;
    case ePEBool_ApplyNoiseToEnd:
      SetApplyNoiseToEnd(abX);
      break;
...
bool cEntityWrapperParticleEmitter::SetProperty(int alPropID, const tString& asX) {
  switch (alPropID) {
    case ePEStr_PEType:
      SetPEType(ToPEType(asX.c_str()));
      break;

    case ePEStr_StartPosType:
      SetStartPosType(ToStartPosType(asX.c_str()));
      break;

    case ePEStr_CoordSystem:
      SetCoordSystem(ToCoordSystem(asX.c_str()));
      break;

    case ePEStr_StartVelType:
      SetStartVelType(ToStartPosType(asX.c_str()));
      break;

    case ePEStr_DrawType:
      SetDrawType(ToDrawType(asX.c_str()));
      break;

    case ePEStr_GravityType:
      SetGravityType(ToGravityType(asX.c_str()));
      break;

    case ePEStr_PartSpinType:
      SetPartSpinType(ToPartSpinType(asX.c_str()));
      break;


    case ePEStr_DeathType:
      SetDeathType(ToDeathType(asX.c_str()));
      break;
    ...
    case ePEStr_SubDivType:
      SetSubDivisionType(ToSubDivType(asX.c_str()));
      break;
...
bool cEntityWrapperParticleEmitter::SetProperty(int alPropID, const cVector2f& avX) {
  switch (alPropID) {
    case ePEVec2f_MinStartAngles:
      SetMinStartAngles(avX);
      break;

    case ePEVec2f_MaxStartAngles:
      SetMaxStartAngles(avX);
      break;

    case ePEVec2f_MinStartVelAngles:
      SetMinStartVelAngles(avX);
      break;

    case ePEVec2f_MaxStartVelAngles:
      SetMaxStartVelAngles(avX);
      break;
...
void cEntityWrapperParticleEmitter::SetMaterial(const tString& asX) {
  ...
  if (lLength >= 0 && sSanitizedFile[lLength] == ' ')
    sSanitizedFile = cString::Sub(sSanitizedFile, 0, lLength);
