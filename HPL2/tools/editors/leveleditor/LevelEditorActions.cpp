...
cLevelEditorActionGroupAdd::cLevelEditorActionGroupAdd(iEditorBase* apEditor, unsigned int alID, const tString& asName)
    : iEditorAction("Add group") {
  mpEditor = apEditor;
  mlID     = alID;
  msName   = asName;
...
cLevelEditorActionGroupAddSelected::cLevelEditorActionGroupAddSelected(iEditorBase* apEditor, unsigned int alID)
    : iEditorAction("Add selected entities to group") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupDelete::cLevelEditorActionGroupDelete(iEditorBase* apEditor, unsigned int alID)
    : iEditorAction("Delete group") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupDeselectEntities::cLevelEditorActionGroupDeselectEntities(iEditorBase* apEditor, unsigned int alID)
    : iEditorAction("Remove group entities from selection") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupRemoveSelected::cLevelEditorActionGroupRemoveSelected(iEditorBase* apEditor, unsigned int alID)
    : iEditorAction("Remove selected entities from group") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupSelectEntities::cLevelEditorActionGroupSelectEntities(iEditorBase* apEditor, unsigned int alID)
    : iEditorAction("Add selected entities to group") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupSetName::cLevelEditorActionGroupSetName(iEditorBase* apEditor, unsigned int alID, const tString& asName)
    : iEditorAction("Add group") {
  mpEditor = apEditor;
...
cLevelEditorActionGroupSetVisibility::cLevelEditorActionGroupSetVisibility(iEditorBase* apEditor, unsigned int alID, bool abNewValue)
    : iEditorAction("Add group") {
  mpEditor = apEditor;
...
cLevelEditorActionSetSkyboxActive::cLevelEditorActionSetSkyboxActive(iEditorWorld* apWorld, bool abX)
    : iEditorActionWorldModifier("Set Skybox active", apWorld) {
...
cLevelEditorActionSetSkyboxTexture::cLevelEditorActionSetSkyboxTexture(iEditorWorld* apWorld, const tString& asX)
    : iEditorActionWorldModifier("Set Skybox texture", apWorld) {
...
cLevelEditorActionSetSkyboxColor::cLevelEditorActionSetSkyboxColor(iEditorWorld* apWorld, const cColor& aX)
    : iEditorActionWorldModifier("Set Skybox color", apWorld) {
...
cLevelEditorActionSetFogBoolProperty::cLevelEditorActionSetFogBoolProperty(iEditorWorld* apWorld, eFogBoolProp aProp, bool abX)
    : iEditorActionWorldModifier("Set Skybox active", apWorld) {
  mProp = aProp;
...
cLevelEditorActionSetFogFloatProperty::cLevelEditorActionSetFogFloatProperty(iEditorWorld* apWorld, eFogFloatProp aProp, float afX)
    : iEditorActionWorldModifier("Set Fog float", apWorld) {
  mProp = aProp;
...
cLevelEditorActionSetFogColor::cLevelEditorActionSetFogColor(iEditorWorld* apWorld, const cColor& aX)
    : iEditorActionWorldModifier("Set Fog color", apWorld) {
...
cLevelEditorActionSetGlobalMaxDecalTris::cLevelEditorActionSetGlobalMaxDecalTris(iEditorWorld* apWorld, int alMaxTris)
    : iEditorActionWorldModifier("Set Max triangles per decal", apWorld) {
...
cLevelEditorActionAddStaticObjectCombo::cLevelEditorActionAddStaticObjectCombo(iEditorWorld* apWorld)
    : iEditorActionWorldModifier("Add static object combo", apWorld) {
...
cLevelEditorActionRemoveStaticObjectCombo::cLevelEditorActionRemoveStaticObjectCombo(iEditorWorld* apWorld, int alComboID)
    : iEditorActionWorldModifier("Remove combo", apWorld) {
  cLevelEditorWorld* pWorld = (cLevelEditorWorld*) mpEditorWorld;
...
cLevelEditorActionAddObjectToCombo::cLevelEditorActionAddObjectToCombo(iEditorWorld* apWorld, cLevelEditorStaticObjectCombo* apCombo, cEntityWrapperStaticObject* apObj)
    : iEditorActionWorldModifier("Add object to combo", apWorld) {
  ////////////////////////////////////////////////////////////
...
void cLevelEditorActionAddObjectToCombo::Apply(int alComboToRemove, int alComboToAdd) {
  ...
  if (pCombo)
    pCombo->RemoveObject(pObject);

  pCombo = pWorld->GetStaticObjectCombo(alComboToAdd);
  if (pCombo)
    pCombo->AddObject(pObject);
}

//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------

cLevelEditorActionRemoveObjectFromCombo::cLevelEditorActionRemoveObjectFromCombo(iEditorWorld* apWorld, cLevelEditorStaticObjectCombo* apCombo, cEntityWrapperStaticObject* apObj)
    : iEditorActionWorldModifier("Add object to combo", apWorld) {
  ////////////////////////////////////////////////////////////
  // Condition for the action to be invalid is objectID==-1
  // if no object, or already in combo, invalidate!
...
cLevelEditorActionComboSetColor::cLevelEditorActionComboSetColor(iEditorWorld* apWorld, int alComboID, const cColor& aCol)
    : iEditorActionWorldModifier("Set combo color", apWorld) {
  cLevelEditorWorld* pWorld = (cLevelEditorWorld*) apWorld;
