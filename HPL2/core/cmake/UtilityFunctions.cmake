...
function(_BuildDynamicTarget name type)
  ...
  foreach (dir ${ARGN})
    ...
    elseif (dir STREQUAL "LINK")
      ...
      if (_mode STREQUAL "excl")
        file(GLOB _files RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} ${dir})
        if (_files)
          list(REMOVE_ITEM _source_files ${_files})
        endif ()
      elseif (_mode STREQUAL "files")
        list(APPEND _source_files ${dir})
      elseif (_mode STREQUAL "incl")
        list(APPEND _include_dirs ${dir})
      elseif (_mode STREQUAL "define")
        list(APPEND _definitions ${dir})
      elseif (_mode STREQUAL "flags")
        list(APPEND _flags ${dir})
      elseif (_mode STREQUAL "link")
        list(APPEND _link_libs ${dir})
      elseif (_mode STREQUAL "dirs")
        file(GLOB _files RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}
          ...
          ${dir}/*.inl)
        if (_files)
          list(APPEND _source_files ${_files})
        endif ()
      else ()
  ...
  if (type STREQUAL "lib")
    add_library(${name} EXCLUDE_FROM_ALL ${_source_files})
  else ()
    add_executable(${name} MACOSX_BUNDLE WIN32 ${_source_files})
  endif ()
  if (_include_dirs)
