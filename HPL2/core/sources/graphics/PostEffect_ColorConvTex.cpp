...
#define kVar_afFadeAlpha 0
  ...
  iPostEffect* cPostEffectType_ColorConvTex::CreatePostEffect(iPostEffectParams* apParams) {
    auto* pEffect      = hplNew(cPostEffect_ColorConvTex, (mpGraphics, mpResources, this));
    auto* pBloomParams = dynamic_cast<cPostEffectParams_ColorConvTex*>(apParams);
  ...
  cPostEffect_ColorConvTex::cPostEffect_ColorConvTex(cGraphics* apGraphics, cResources* apResources, iPostEffectType* apType)
    ...
    mpSpecificType = dynamic_cast<cPostEffectType_ColorConvTex*>(mpType);
